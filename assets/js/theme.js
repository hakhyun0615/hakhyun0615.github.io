...
// Toggle between light and dark, remembering the visitor's choice.
...
// Start in light mode unless the visitor explicitly chose dark mode.
// Previous "system" preferences also use the new light default.
let determineThemeSetting = () => {
  return localStorage.getItem("theme") === "dark" ? "dark" : "light";
};

// The displayed theme always follows the visitor's selection.
