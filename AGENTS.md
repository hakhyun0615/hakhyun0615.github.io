...
## Personal-site privacy requirement

The owner's CV is private. Edit its local source in `/Users/hakhyunkim/Desktop/Resume/` when requested, but never copy or commit the CV PDF or source into this repository or deploy it with the website. Website and CV updates do not authorize publishing the CV.
